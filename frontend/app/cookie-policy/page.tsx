...
export default function CookiePolicy() {
  ...
  const { getField } = usePageContent("cookie-policy");

  const pageTitle = getField("hero", "title", lang) || t("Cookie Policy", "Cookiebeleid");
  const effectiveDate = getField("hero", "effectiveDate", lang) || undefined;
