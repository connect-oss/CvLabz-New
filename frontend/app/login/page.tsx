      ...
      <div className="hidden lg:flex lg:w-[45%] relative bg-gray-900 flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="text-gray-400 font-medium text-lg max-w-md leading-relaxed">
              Join thousands of professionals using AI-powered tools to land
              their dream job.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {[
              "AI-powered CV builder & scorer",
              "LinkedIn profile analyzer",
              "Job match scoring in seconds",
        ...
        <div className="relative z-10 bg-white/5 border border-white/10 rounded-xl p-5">
          <p className="text-gray-300 text-sm leading-relaxed mb-3">
            &ldquo;I went from zero callbacks to 4 interviews in two weeks.
            The AI feedback was a game-changer.&rdquo;
          </p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-gray-50">
        ...
        >
          ...
          <p className="text-gray-500 font-medium mb-8">
            {isSignUp
              ? "Start building your career with CV Labz."
              : "Sign in to continue to your dashboard."}
          </p>

          {/* Social login */}
          <button className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 rounded-xl py-3 font-bold text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm mb-4">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3.5 rounded-xl font-extrabold text-base hover:opacity-90 active:scale-[0.99] transition-all shadow-lg shadow-blue-200 flex items-center justify-center gap-2 mt-2"
            >
